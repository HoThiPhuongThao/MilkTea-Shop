...
<div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          >
            ...
            <!-- Topbar Search -->
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="user.php" method="GET">
...
// Lấy tổng số bản ghi
$total_query = "SELECT COUNT(id) AS total FROM user WHERE fullname LIKE '%$search%'";
...
$sql_str = "SELECT user.*, role.name AS role_name 
            FROM user 
            JOIN role 
...
?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger" href="delete_user.php?id=<?=$row['id']?>" onclick="return confirm('Bạn chắc chắn muốn xóa mục này?');">Delete</a>
                            </td>
                        </tr>
<?php
    }
