    ...
    <ul class="navbar">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-content">
                ...
                <li><a href="cake.php">Bánh ngọt</a></li> <!-- Make sure this links to cake.php -->
            </ul>
        </li>
...
<script>
    function searchProduct() {
        ...
        if (searchInput) {
            window.location.href = 'cake.php?search=' + encodeURIComponent(searchInput);  // Update to cake.php
        }
    }
</script>
...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $sql = "SELECT * FROM product WHERE category_id = 115 AND title LIKE '%$searchQuery%' LIMIT $start, $productsPerPage";  // category_id 115 for cake
    $countSql = "SELECT COUNT(*) as total FROM product WHERE category_id = 115 AND title LIKE '%$searchQuery%'";
} else {
    $sql = "SELECT * FROM product WHERE category_id = 115 LIMIT $start, $productsPerPage";  // category_id 115 for cake
    $countSql = "SELECT COUNT(*) as total FROM product WHERE category_id = 115";
}
